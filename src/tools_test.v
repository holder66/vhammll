...
fn test_combinations() {
	assert combinations([1, -2, 3, 6, 0], min: 2) == [[1, -2],
		[1, 3], [1, 6], [1, 0], [-2, 3], [-2, 6], [-2, 0], [3, 6],
		[3, 0], [6, 0], [1, -2, 3], [1, -2, 6], [1, -2, 0], [1, 3, 6],
		[1, 3, 0], [1, 6, 0], [-2, 3, 6], [-2, 3, 0], [-2, 6, 0],
		[3, 6, 0], [1, -2, 3, 6], [1, -2, 3, 0], [1, -2, 6, 0],
		[1, 3, 6, 0], [-2, 3, 6, 0], [1, -2, 3, 6, 0]]
	assert combinations([1.0, 2, 3, 4, 5, 6], min: 2) == [[1.0, 2.0],
	...
	assert combinations([u8(1), 2], min: 2) == [[u8(1), 2]]
	assert combinations(['a', 'b'], min: 2) == [['a', 'b']]
	assert combinations('Henry'.split(''), min: 2) == [['H', 'e'],
		['H', 'n'], ['H', 'r'], ['H', 'y'], ['e', 'n'], ['e', 'r'],
		['e', 'y'], ['n', 'r'], ['n', 'y'], ['r', 'y'], ['H', 'e', 'n'],
		['H', 'e', 'r'], ['H', 'e', 'y'], ['H', 'n', 'r'], ['H', 'n', 'y'],
		['H', 'r', 'y'], ['e', 'n', 'r'], ['e', 'n', 'y'], ['e', 'r', 'y'],
		['n', 'r', 'y'], ['H', 'e', 'n', 'r'], ['H', 'e', 'n', 'y'],
		['H', 'e', 'r', 'y'], ['H', 'n', 'r', 'y'], ['e', 'n', 'r', 'y'],
		['H', 'e', 'n', 'r', 'y']]
