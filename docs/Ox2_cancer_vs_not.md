# Classification of Cancer using Metabolomics, for Oxford second dataset
...
1. Prepend "ID" with "m#" to give "m#ID" (ie, metadata), do the same with "Model". Prepend "Class" with "c#" to give "c#Class", thus specifying the class variax`ble.
